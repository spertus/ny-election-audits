...
for(i in 1:n_sims){
  ...
  if(audit$result == "Audit done; results confirmed"){
    error = error + 1
  }
}
...
# BRAVO Risk-Limiting Audit

In the same simulation scenarios as above, we implement a BRAVO ballot-polling RLA as described in [Lindeman, Stark, and Yates (2012)](https://www.usenix.org/system/files/conference/evtwote12/evtwote12-final27.pdf). 
