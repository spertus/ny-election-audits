...
Let's consider another scenario where for the first 15 machines we give 5% of Hillary Clinton's votes to Trump which results in Trump being incorrectly declared the winner in this county. In this scenario, the audit does *not* catch the error about 60% of the time.
